...
errors = {
    'name_len': 'Ingrese un nombre de contacto entre 4 y 25 carácteres',
...
class Person(FlaskForm):
    id = HiddenField('')
    name = StringField('Nombre Completo', [DataRequired(), length(min=4, max=25, message=errors['name_len'])])
